...
class OrderTableViewController: UITableViewController {
    var orders = ["综合排序","价格从低到高", "价格从高到低", "人气排序", "时间排序"]
    let id = "OrderCell"
    var selectedOrder:String! = "综合排序"
    ...
    override func viewDidLoad() {
        ...
        if let order = selectedOrder {
            selectedOrderIndex = find(orders, order)!
        }
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.row == selectedOrderIndex {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        println("OrderTableViewController segue identifier = " + segue.identifier!)
